...
public final class Info {
    ...
    /**
     * Returns the message declaring that the players, whose names are those given, have finished the game tied by having each won the given points
     * @param playerNames the names of the two players that have drawn
     * @param points the points that the players obtained (to draw)
     * @return the message declaring that the players, whose names are those given, have finished the game tied by having each won the given points
     */
    ...
    private static String cardsName(SortedBag<Card> cards) { //TODO: Optimize this (test available for this?)
        String cardsName = "";
